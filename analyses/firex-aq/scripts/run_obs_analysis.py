#!/usr/bin/env python
"""Run FIREX-AQ observation-only analysis pipeline.

Uses DAVINCI-MONET's obs-only pipeline mode to generate flight track maps,
...
Examples:
    python run_obs_analysis.py firex-aq-obs-dc8
"""
...
def main() -> None:
    config_name = sys.argv[1] if len(sys.argv) > 1 else "firex-aq-obs-dc8"
    ...
    print("=" * 70)
    print("FIREX-AQ Observation-Only Analysis")
    print("=" * 70)
