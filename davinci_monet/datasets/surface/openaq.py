"""OpenAQ global air quality dataset reader.
...
class OpenAQReader:
    ...
    def open(
        ...
        **kwargs
        ...
        -------
        xr.Dataset
            OpenAQ datasets with dimensions (time, x).
        """
    ...
    def _open_with_monetio(
        ...
        **kwargs: Any,
        ...
        try:
            df: pd.DataFrame = openaq_module.add_data(start_date, end_date, **mio_kwargs)
