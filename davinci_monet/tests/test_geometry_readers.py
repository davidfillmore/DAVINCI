"""Tests for dataset reader implementations.

Tests the dataset reader classes using synthetic datasets.
"""
...
import davinci_monet.datasets.aircraft.icartt  # noqa: F401
import davinci_monet.datasets.satellite.goes_l3_aod  # noqa: F401
import davinci_monet.datasets.satellite.modis_l2_aod  # noqa: F401
import davinci_monet.datasets.satellite.mopitt_l3_co  # noqa: F401
import davinci_monet.datasets.satellite.omps_l3_o3  # noqa: F401
import davinci_monet.datasets.satellite.tempo_l2_no2  # noqa: F401
import davinci_monet.datasets.satellite.tropomi  # noqa: F401
import davinci_monet.datasets.sonde.ozonesonde  # noqa: F401
import davinci_monet.datasets.surface.aeronet  # noqa: F401
import davinci_monet.datasets.surface.airnow  # noqa: F401

# Import readers to ensure they are registered
import davinci_monet.datasets.surface.aqs  # noqa: F401
import davinci_monet.datasets.surface.openaq  # noqa: F401
from davinci_monet.core.protocols import DataGeometry
from davinci_monet.core.registry import source_registry

# =============================================================================
# Helper functions for creating synthetic dataset data
# =============================================================================


def create_synthetic_surface_geometry(
    n_sites: int = 10,
    n_times: int = 24,
    variables: list[str] | None = None,
) -> xr.Dataset:
    """Create synthetic surface dataset data."""
...
def create_synthetic_gridded_geometry(
    n_lat: int = 50,
    n_lon: int = 100,
    n_times: int = 24,
    variables: list[str] | None = None,
) -> xr.Dataset:
    """Create synthetic gridded dataset data."""
    if variables is None:
        variables = ["AOD"]
...
def create_synthetic_profile_geometry(
    n_levels: int = 100,
    variables: list[str] | None = None,
) -> xr.Dataset:
...
class TestGeometryRegistry:
    ...
    def test_surface_readers_registered(self):
        ...
        assert "aqs" in source_registry
        assert "airnow" in source_registry
        assert "aeronet" in source_registry
        assert "openaq" in source_registry

    def test_aircraft_readers_registered(self):
        """Test that aircraft readers are registered."""
        assert "icartt" in source_registry

    def test_satellite_readers_registered(self):
        """Test that satellite readers are registered."""
        assert "tropomi" in source_registry
        assert "goes_l3_aod" in source_registry
        assert "tempo_l2_no2" in source_registry
        assert "modis_l2_aod" in source_registry
        assert "mopitt_l3_co" in source_registry
        assert "omps_l3_o3" in source_registry

    def test_sonde_readers_registered(self):
        """Test that sonde readers are registered."""
        assert "ozonesonde" in source_registry

    def test_get_reader_class(self):
        """Test getting reader classes from registry."""
        aqs_cls = source_registry.get("aqs")
...
class TestAQSReader:
    ...
    def test_open_netcdf_file(self):
        ...
        ds = create_synthetic_surface_geometry()
...
class TestGOESL3AODReader:
    ...
    def test_reader_name(self):
        """Test reader name."""
        from davinci_monet.datasets.satellite.goes_l3_aod import GOESL3AODReader
    ...
    def test_open_with_xarray(self):
        ...
        ds = create_synthetic_gridded_geometry()
    ...
    def test_backward_compatibility_alias(self):
        ...
        from davinci_monet.datasets.satellite.goes_l3_aod import GOESReader
...
class TestTEMPOL2NO2Reader:
    ...
    def test_reader_name(self):
        """Test reader name."""
        from davinci_monet.datasets.satellite.tempo_l2_no2 import TEMPOL2NO2Reader
...
class TestMOPITTL3COReader:
    ...
    def test_reader_name(self):
        """Test reader name."""
        from davinci_monet.datasets.satellite.mopitt_l3_co import MOPITTL3COReader
...
class TestOMPSL3O3Reader:
    ...
    def test_reader_name(self):
        """Test reader name."""
        from davinci_monet.datasets.satellite.omps_l3_o3 import OMPSL3O3Reader
...
class TestOzonesondeReader:
    ...
    def test_open_netcdf_file(self):
        ...
        ds = create_synthetic_profile_geometry()
...
class TestReaderOpen:
    ...
    ``create_geometry_data`` factory were removed; sources load through
