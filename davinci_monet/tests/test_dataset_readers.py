...
from davinci_monet.datasets import (
    CESMFVReader,
    CESMSEReader,
    CMAQReader,
    GenericReader,
...
# =============================================================================
# Fixtures for synthetic dataset data
# =============================================================================
...
class TestWRFChemReader:
    """Tests for WRF-Chem dataset reader."""
    ...
    def test_standardize_dataset_decodes_wrf_times_chararray(self) -> None:
        ...
        it into a datetime coord so downstream pairing can align with geometry."""
    ...
    def test_drop_uninitialized_chem_steps_drops_zero_pm_step(self) -> None:
        ...
        datasets silently biases stats negative by ~1.5 µg/m³ and
        ...
        loud warning so downstream pairing/stats see only valid dataset fields.
        """
...
class TestCESMFVReader:
    """Tests for CESM-FV dataset reader."""
...
class TestCESMSEReader:
    """Tests for CESM-SE dataset reader."""
...
class TestGenericReader:
    """Tests for generic dataset reader."""
...
class TestGenericReaderOpen:
    ...
    The universal ``open_dataset`` convenience function was removed; sources now
...
class TestDatasetReaderRoundTrip:
    """Round-trip tests for dataset readers (calls internal APIs directly)."""
